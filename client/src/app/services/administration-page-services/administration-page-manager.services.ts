...
export class AdministrationPageManagerService {
    games: Game[] = [
        ...
        },
        {
            ...
            isVisible: true,
            description:
                'Penny the Penguin returns to Antarctica to serve up a feast! After a very successful stint in the Arctic, Penny decides to open up her own diner on home territory.',
        },
        {
            id: 3,
            name: 'Super Mario',
            ...
            isVisible: true,
            description:
                'Super Mario is a platform game series created by Nintendo, featuring their mascot, Mario. Alternatively called the Super Mario Bros. series or simply the Mario series, it is the central series of the greater Mario franchise',
        },
    ];
    //rien de spécial
