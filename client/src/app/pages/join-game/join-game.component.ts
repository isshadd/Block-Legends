...
export class JoinGameComponent {
    ...
    joinGame(): void {
        ...
        if (this.accessCode === this.gameService.getAccessCode()) {
            this.gameService.addPlayer(playerCharacter);
            this.router.navigate(['/waiting-view']);
        } else if (!this.accessCode || this.accessCode !== this.gameService.getAccessCode()) {
